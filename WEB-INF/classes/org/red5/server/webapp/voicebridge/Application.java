...
public class Application extends ApplicationAdapter implements IStreamAwareScopeHandler, CallEventListener  {
    ...
    {
    	loginfo("Red5VoiceBridge manageParticipant");
    ...
    {
    	loginfo("Red5VoiceBridge manageConference");
    ...
    {
    	loginfo("Red5VoiceBridge migrateCall");
	...
	private void reportError(String error)
	{
		...
		logerror("Red5VoiceBridge " + error);
	}
